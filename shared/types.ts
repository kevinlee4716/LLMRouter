...
export type Platform =
  ...
  | 'aihorde'
  // 阿里云百炼 (Model Studio) — OpenAI-compatible via dashscope.aliyuncs.com
  // compatibility endpoint. Supports Qwen and DeepSeek via the
  // /compatible-mode/v1 base. Key from bailian.console.aliyun.com.
  | 'aliyun'
  // 百度千帆 (Qianfan) — OpenAI-compatible via qianfan.baidubce.com v2
  // endpoint. Baidu fully switched to the v2 OpenAI-compatible API post-2025.
  // Key from console.bce.baidu.com/qianfan.
  | 'qianfan'
