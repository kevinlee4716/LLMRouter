/**
 * export-catalog — build the signed catalog product from the live LLMRouter DB.
 *
 ...
 *                                     [--stdout]
 *
 * Defaults: reads the server's data/llmrouter.db, writes the suite's
...
const SUITE_ROOT = path.resolve(__dirname, '../../../..'); // llmrouter/server/src/scripts -> suite root
