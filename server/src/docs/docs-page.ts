...
<head>
  ...
  <title>LLMRouter - API reference</title>
  <style>
    :root {
...
<body>
  <header class="top"><div class="wrap" style="padding:0;"><h1 id="doc-title">LLMRouter</h1><span class="ver" id="doc-ver"></span></div></header>
