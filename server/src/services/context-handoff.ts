import type { ChatMessage } from '@llmrouter/shared/types.js';
...
export function getContextHandoffMode(): ContextHandoffMode {
  const raw = process.env.LLMROUTER_CONTEXT_HANDOFF?.trim().toLowerCase();
